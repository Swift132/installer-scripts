#!/bin/bash
# 2023 - By: Jọo Vieira & Diogo Pacheco | 'jvieira9' & 'swift132' on GitHub
...
function show_progress_bar() {
    ...
    while [ "$(ps a | awk '{print $1}' | grep $pid)" ]; do
        ...
        if [ $progress -gt 50 ]; then progress=0; fi
    done
    printf "["
...
clear
printf "\033[32mUpdating packages...\n\033[0m"
...
printf " \n"
printf " \n"
printf "\033[31mPackages updated successfully.\n\033[0m"
printf " \n"
  ...
  case $opt in
    "Google Chrome")
        ...
        then
            ...
            wget https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb >> install.log 2> error.log & show_spinner $!
    ...
    "Visual Studio Code")
        ...
        then
            ...
            sudo snap install code --classic >> install.log 2> error.log & show_spinner $!
            printf " \n"
    ...
    "Git")
        ...
        then
            ...
            sudo apt install git -y >> install.log 2> error.log & show_spinner $!
            printf " \n"
    ...
    "Docker")
        ...
        then
            ...
            sudo usermod -aG docker $USER >> install.log 2> error.log & show_spinner $!
    ...
    "Python")
        ...
        then
            ...
            sudo apt install python3 python3-pip -y >> install.log 2> error.log & show_spinner $!
    ...
    "Node.js")
        ...
        then
            ...
            sudo apt-get install -y nodejs >> install.log 2> error.log & show_spinner $!
    ...
    "VirtualBox")
        ...
        if ! command -v virtualbox --help >> install.log 2> error.log & show_spinner $!
        then
            printf " \n"
    ...
    "VLC")
        ...
        then
            ...
            sudo apt install vlc -y  >> install.log 2> error.log & show_spinner $!
    ...
    "Notepadqq")
        ...
        then
            ...
            sudo apt install notepadqq -y  >> install.log 2> error.log & show_spinner $!
    ...
    "Discord")
        ...
        then
            ...
            sudo snap install discord >> install.log 2> error.log & show_spinner $!
    ...
    "KeePass2")
        ...
        then
            ...
            sudo apt install keepass2 -y >> install.log 2> error.log & show_spinner $!
    ...
    "Spotify")
        ...
        then
            ...
            sudo snap install spotify >> install.log 2> error.log & show_spinner $!
    ...
    "GIMP")
        ...
        then
            ...
            sudo apt install gimp -y >> install.log 2> error.log & show_spinner $!
