...
for opt in "${selected[@]}"; do
    ...
    "Google Chrome")
        ...
        if ! dpkg -l google-chrome-stable >>install.log 2>error.log; then
            printf " \n"
            printf "Installing Google Chrome...\n"
            wget https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb >>install.log 2>error.log
            sudo dpkg -i google-chrome-stable_current_amd64.deb | sudo tee -a install.log >/dev/null 2>error.log &
            spinnerPercentage $!
            printf " \n"
    ...
    "Visual Studio Code")
        ...
        if ! command -v code >>install.log 2>error.log; then
            printf " \n"
    ...
    "Git")
        ...
        if ! command -v git >>install.log 2>error.log; then
            printf " \n"
    ...
    "Python")
        ...
        if ! command -v python3 >>install.log 2>error.log; then
            printf " \n"
    ...
    "Node.js")
        ...
        if ! command -v node -v >>install.log 2>error.log; then
            printf " \n"
    ...
    "VirtualBox")
        ...
        if ! command -v virtualbox --help >>install.log 2>error.log; then
            printf " \n"
    ...
    "VLC")
        ...
        if ! command -v vlc --version >>install.log 2>error.log; then
            printf " \n"
    ...
    "Notepadqq")
        ...
        if ! command -v notepadqq >>install.log 2>error.log; then
            printf " \n"
    ...
    "Discord")
        ...
        if ! command -v discord --version >>install.log 2>error.log; then
            printf " \n"
    ...
    "KeePass2")
        ...
        if ! command -v keepass2 --version >>install.log 2>error.log; then
            printf " \n"
    ...
    "Spotify")
        ...
        if ! command -v spotify --version >>install.log 2>error.log; then
            printf " \n"
    ...
    "GIMP")
        ...
        if ! command -v gimp --version >>install.log 2>error.log; then
            printf " \n"
